...
plt.imshow(corr_matrix_speech, aspect='auto', vmin=0, vmax=b)
plt.title('speech')
plt.colorbar()
plt.show()
plt.close()
...
plt.figure(figsize=(12,10))
plt.imshow(corr_matrix_music, aspect='auto', vmin=0, vmax=b)
plt.title('music')
plt.colorbar()
plt.show()
plt.close()
...
plt.figure(figsize=(12,10))
plt.imshow(corr_matrix_rest, aspect='auto', vmin=0, vmax=b)
plt.title('rest')
plt.colorbar()
plt.show()
plt.close()
