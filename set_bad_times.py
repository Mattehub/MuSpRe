...
sav.save_obj(set_speech, path + "/set_speech_bad_times_100hz")
sav.save_obj(set_music, path +"/set_music_bad_times_100hz")
sav.save_obj(set_rest, path + "/set_rest_bad_times_100hz")
